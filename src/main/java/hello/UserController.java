...
@RequestMapping(value = "/api/v1/users", method = RequestMethod.POST,headers="Accept=application/json")
...
//Update user API :/users/{user_id}
    ...
    @RequestMapping(value = "/api/v1/users/{user_id}",method = RequestMethod.PUT,headers="Accept=application/json")
@ResponseStatus(value=HttpStatus.CREATED)
...
//Create ID Card APT : /users/{user_id}/idcard
    @RequestMapping(value = "/api/v1/users/{user_id}/idcard",method =      RequestMethod.POST,headers="Accept=application/json")
@ResponseStatus(value=HttpStatus.CREATED)   
...
@RequestMapping(value = "/api/v1/users/{user_id}/weblogin",method =      RequestMethod.POST,headers="Accept=application/json")
 @ResponseStatus(value=HttpStatus.CREATED)   
...
@RequestMapping(value = "/api/v1/users/{user_id}/bankaccount",method =      RequestMethod.POST,headers="Accept=application/json")
 @ResponseStatus(value=HttpStatus.CREATED)   
